...
If the user asks for a draft PRD: markdown doc with sections Problem / Goal / Evidence (each line cites a Source ID) / Scope / Out of scope / Open questions.
...
Output row: | 1 | Jira export broken; manual workaround | "Third report this week" | Ticket #48211 | Scope one-click Jira export preserving markdown |
```
